  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,_#1f2937_0,_#020617_45%,_#000_80%)] px-4 py-10 text-zinc-50 sm:px-8">
      <main className="mx-auto flex w-full max-w-6xl flex-col gap-10 sm:gap-14">
        ...
        <section className="grid gap-10 lg:grid-cols-[minmax(0,_2fr)_minmax(0,_1.4fr)] lg:items-start">
          <div className="space-y-8">
            <div className="inline-flex items-center gap-2 rounded-full border border-zinc-800/80 bg-zinc-900/60 px-3 py-1 text-xs text-zinc-300 shadow-sm backdrop-blur">
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <Button variant="outline" size="lg" className="border-zinc-700/80 bg-transparent text-sm text-zinc-100">
              ...
              {highlights.map((item) => (
                ...
                >
                  <CardHeader className="mb-3 space-y-1">
                    <CardTitle className="text-xs font-medium uppercase tracking-[0.14em] text-zinc-400">
                      {item.title}
                    </CardTitle>
                  </CardHeader>
          ...
          <Card className="border-zinc-800/80 bg-zinc-950/70 text-zinc-50 shadow-xl shadow-emerald-500/10">
            <CardHeader>
              <CardTitle className="flex items-center justify-between text-sm font-semibold text-zinc-100">
                ...
                <span className="rounded-full bg-zinc-900 px-2 py-0.5 text-[10px] font-medium text-zinc-300">
                  Draft
                </span>
              </CardTitle>
              <CardDescription className="text-xs text-zinc-400">
            ...
            <CardContent className="space-y-5">
              <div className="rounded-lg border border-zinc-800/80 bg-gradient-to-b from-zinc-950 to-zinc-900/80 p-4">
                ...
                <div className="mt-4 grid gap-3 text-xs text-zinc-300 sm:grid-cols-3">
